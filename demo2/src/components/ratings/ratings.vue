<template>
    <div class="ratings" ref="ratings">
        <div class="ratings-content">
            ...
            <split></split>
            <rating-select :select-type.sync="selectType" :only-content.sync="onlyContent"  :ratings="ratings" :desc="desc" @rating-type-select="selectRating" @content-toggle="toggleContent"></rating-select>
